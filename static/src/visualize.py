    ...
    def __init__(self, map, schedule):
        ...
        if WAREHOUSE==False:
            ...
            for o in warehouse_rectangles:
                x1,x2,y1,y2=o
                self.patches.append(Rectangle((x1,y1),width=x2-x1,height=y2-y1,angle=0,facecolor='grey'))
        ...
        for i in range(self.num_agents):
            ...
            line, = self.ax.plot(
                self.list_xdata[i], self.list_ydata[i], color=cmap(i+1),  alpha=0.3, lw=5, linestyle="-.")
        ...
        # self.anim.save('./demo_ecbs.mp4',fps=10)
