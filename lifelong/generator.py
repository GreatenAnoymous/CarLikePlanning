...
def generate_empty_instances():
    ...
    for agent in agents:
        ...
        for k in range(10):
            ...
            instance_name = "./instances/lifelong/random/agents_" + \
                str(agent)+"_"+str(k)+".json"

            save_instance_json(instance_name, starts,
                               tasks, xmax, ymax, obstacles)
            print(instance_name)
...
def generate_large_instances():
    ...
    for agent in agents:
        ...
        for k in range(10):
            ...
            instance_name = "./instances/lifelong/empty_large/agents_" + \
                str(agent)+"_"+str(k)+".json"
    ...
    for agent in agents:
        ...
        for k in range(1):
            ...
            for i in range(num_tasks):
                ...
                for j, goal in enumerate(goals):
                    tasks[j].append(goal)
            print(len(tasks), len(tasks[0]), len(tasks[1]))
